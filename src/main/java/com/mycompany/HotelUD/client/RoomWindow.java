...
public class RoomWindow extends JFrame {
	...
	public RoomWindow() {
		...
		panel_1.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, UIManager.getColor("List.selectionBackground"), null,
				null, null));
		...
		panel_2.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, UIManager.getColor("List.selectionBackground"), null,
				null, null));
